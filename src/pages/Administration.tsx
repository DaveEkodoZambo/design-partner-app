...
const Administration = () => (
  <ModuleCards
    ...
    cards={[
      ...
      {
        id: "services", title: "Unité Administrative",
        description: "Organisez la structure de la CUY : directions, services, sous-services et postes avec leurs descriptions détaillées.",
        icon: Building2, path: "/administration/services", color: "bg-secondary",
        stats: [{ label: "Unités", value: "18", icon: Building2 }, { label: "Actives", value: "16", icon: Activity }],
      },
    ]}
  />
);
